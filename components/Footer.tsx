    ...
    <footer id="contact" className="bg-gray-900 text-gray-300 py-16">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-serif tracking-widest text-white mb-6">
              LUXE
            </h3>
            <p className="font-light">
              Redefining luxury fashion for the modern era, with a commitment to
          ...
          {/* Navigation */}
          <div>
            <h4 className="uppercase text-sm tracking-wider text-white mb-6">
              Navigation
            </h4>
          ...
          <div>
            ...
            <form className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="px-4 py-2 bg-gray-800 text-white placeholder:text-gray-400 flex-grow"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-white text-gray-900 uppercase text-sm tracking-wider hover:bg-gray-200 transition-colors"
              >
                Subscribe
              </button>
            </form>
